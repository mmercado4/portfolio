const id = "es/accom.md";
						...
						const data = {position:2,company:"Accom",jobPosition:"Desarrollador Full Stack",period:"Dic 2021 - Oct 2022",logo:"logo-accom.jpg",stack:"php, javascript, reactJs, Sass, MongoDb, Code Igniter",url:"https://www.we-accom.com/"};
						const _internal = {
							type: 'content',
							filePath: "/Users/user/Documents/otros/portfolio/src/content/experience/es/accom.md",
							rawData: undefined,
						};
